...
# def draw_branches(start_point, angle, length, depth=5, length_factor=0.75):
#     if depth == 0:
#         return
#
...
#     right_branch.draw()
#
#     draw_branches(start_point=right_branch.end_point, angle=next_angle_right_branch, length=length * length_factor, depth=depth-1)
#     draw_branches(start_point=left_branch.end_point, angle=next_angle_left_branch, length=length * length_factor, depth=depth-1)
#
# point_start = sd.get_point(250, 30)
# draw_branches(point_start, 90, 100)
#
# sd.pause()
